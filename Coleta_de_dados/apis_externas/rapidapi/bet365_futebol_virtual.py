...
class Bet365FutebolVirtualAPI(RapidAPIBase):
    ...
    def __init__(self, api_key: Optional[str] = None):
        config = RapidAPIConfig(
            base_url="https://bet365-sports-odds.p.rapidapi.com",
            api_key=api_key,
            host="bet365-sports-odds.p.rapidapi.com",
            endpoints={
                "virtual_football": "/virtual-football",
                "virtual_matches": "/virtual-matches",
                "virtual_odds": "/virtual-odds",
                "virtual_results": "/virtual-results",
                "virtual_statistics": "/virtual-statistics"
            }
        )
