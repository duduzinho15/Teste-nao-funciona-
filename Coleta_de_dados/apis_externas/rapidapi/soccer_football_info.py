...
class SoccerFootballInfoAPI(RapidAPIBase):
    ...
    async def coletar_jogos(self, liga_id: Optional[str] = None, 
        ...
        """
        Coleta jogos da API Soccer Football Info.
        ...
        try:
            ...
            for partida in response['matches']:
                jogo_padronizado = self._padronizar_jogo(partida)
                if jogo_padronizado:
                    jogos.append(jogo_padronizado)
            
            logger.info(f"Coletados {len(jogos)} jogos da Soccer Football Info")
            return jogos
    ...
    async def coletar_jogadores(self, clube_id: Optional[str] = None,
        ...
        """
        Coleta jogadores da API Soccer Football Info.
        ...
        try:
            ...
            logger.info(f"Coletados {len(jogadores)} jogadores da Soccer Football Info")
            return jogadores
